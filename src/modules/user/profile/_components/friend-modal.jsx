        ...
        <div className="no-scrollbar flex-1 overflow-y-auto">
          {isLoading ? (
              ...
              {filteredFriends.map((friend) => (
                ...
                >
                  <div
                    ...
                    onClick={() => {
                      router.push(`/others-profile/${friend.username}`);
                      onClose();
                    }}
                  >
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-400">{friend.name}</p>
                    </div>
                  </div>
                  <ButtonCommon
                    variant="outline"
                    ...
                    className="text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-neutral-800"
                  >
                    View Profile
                  </ButtonCommon>
                </div>
            ...
            <div className="flex h-[200px] flex-col items-center justify-center text-gray-500 dark:text-gray-400">
              <p className="mb-2 text-lg font-medium">No friends found</p>
              <p className="text-sm">
                {searchQuery
