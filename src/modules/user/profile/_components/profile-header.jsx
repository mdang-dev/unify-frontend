    ...
    <div className="ml-12 flex-1">
      ...
      <div className="mt-4 flex space-x-8">
        ...
        >
          ...
          <span className="font-medium text-zinc-500 dark:text-zinc-400">Friends</span>
        </div>
        <div
          className="cursor-pointer text-center transition-opacity hover:opacity-80"
        ...
        >
          ...
          <span className="font-medium text-zinc-500 dark:text-zinc-400">Followers</span>
        </div>
        <div
          className="cursor-pointer text-center transition-opacity hover:opacity-80"
        ...
        >
          ...
          <span className="font-medium text-zinc-500 dark:text-zinc-400">Following</span>
        </div>
      </div>
      ...
      <div className="mt-6 flex space-x-3">
        <button
          className="flex w-full items-center justify-center rounded-lg bg-gray-100 px-4 py-2 font-semibold transition-colors hover:bg-gray-200 dark:bg-neutral-700 dark:hover:bg-neutral-600"
          onClick={onEdit}
        >
