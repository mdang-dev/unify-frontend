    ...
    <MainLayout>
      <div className="flex">
        <div className="h-screen basis-3/4">
          <div
            id="newsfeed"
            className="no-scrollbar h-full overflow-y-scroll bg-[#f5f5f5] py-8 dark:bg-neutral-900"
          >
        ...
        <div className="sticky top-0 h-screen basis-1/4 border-l border-neutral-200 py-8 dark:border-transparent">
          <div className="mx-auto flex w-3/4 flex-col">
            <div>
              <p className="mb-8 text-center text-lg font-bold">{t('PeopleYouMayKnow')}</p>
            ...
            <div>
              ...
              <p className="mt-8 text-sm text-zinc-300">{t('Copyright')}</p>
            </div>
          </div>
        </div>
      </div>
