    ...
    <div className="flex items-center justify-center bg-black/20 backdrop-blur-lg p-4">
      <div className="flex items-center gap-4 rounded-full bg-white/10 px-6 py-3 backdrop-blur-lg">
        ...
        <button
          ...
          className="flex h-12 w-12 items-center justify-center rounded-full bg-gray-600 hover:bg-gray-700 transition-all duration-200"
        >
        ...
        <button
          onClick={onEndCall}
          className="flex h-12 w-12 items-center justify-center rounded-full bg-red-500 hover:bg-red-600 transition-all duration-200"
        >
      ...
      <div className="absolute bottom-4 left-4 flex items-center gap-2 text-white text-sm">
        ...
        {isScreenSharing && (
          <div className="flex items-center gap-1 rounded-full bg-blue-500 px-2 py-1">
