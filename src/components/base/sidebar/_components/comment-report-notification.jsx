...
const CommentReportNotification = React.memo(function CommentReportNotification({ isSeen, sender, timestamp, onClick, data }) {
  ...
  const entityInfo = useMemo(() => {
    ...
    try {
      ...
      console.error('Comment Report Notification - parsing error:', error);
      return { entityId: null, adminId: null, adminReason: null };
    }
  }, [data]);
          ...
          <div className="flex items-center justify-between gap-2">
            <p className="text-md dark:text-zinc-300">
              ...
              <span className="text-black dark:text-zinc-300 font-medium">
                Your comment has just been reported.
              </span>{' '}
            </p>
          </div>
...
export default CommentReportNotification;
