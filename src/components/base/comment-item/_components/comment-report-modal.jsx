...
const CommentReportModal = ({ isOpen, onClose, onSubmit, commentId }) => {
  ...
  const handleSubmit = () => {
    ...
    onSubmit(commentId, finalReason);
    handleClose();
  };
          ...
          {selectedReason === 'Other' && (
            <div className="mt-4">
              ...
              <textarea
                ...
                placeholder="Please describe the reason for reporting this comment..."
                className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm focus:border-neutral-800 focus:outline-none focus:ring-2 focus:ring-neutral-800 dark:border-neutral-700 dark:bg-neutral-800 dark:text-gray-300 dark:focus:border-zinc-200 dark:focus:ring-zinc-200"
                rows={3}
              />
            </div>
          )}
